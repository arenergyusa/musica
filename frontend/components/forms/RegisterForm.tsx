  ...
  async function onSubmit(data: RegisterInput) {
    ...
    try {
      await api.post("/auth/register", {
        ...
        referral_code: data.referralCode, // mapped to snake_case for backend
      });
      ...
      // Error is handled by api interceptor, but we can also log or add specific logic here if needed
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <p className="text-xs text-muted-foreground mt-1">If you were referred, enter the code here.</p>
                <FormMessage />
              </FormItem>
            )}
          />
