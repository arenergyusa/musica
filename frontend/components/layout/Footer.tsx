      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-slate-200/80 dark:border-slate-800 pt-6 flex flex-col space-y-3">
          <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed">
            <strong>Company Notice:</strong> {APP.NAME} is a digital music streaming platform. The company works exclusively in Haryanvi music video production, song recording, and official music distribution.
          </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-100 dark:border-slate-800">
            <div className="flex flex-col space-y-1 text-center md:text-left">
              <p className="font-semibold text-slate-900 dark:text-white">© {currentYear} Musica. All rights reserved.</p>
