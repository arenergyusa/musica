      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="glass-card max-w-5xl mx-auto p-10 md:p-16 text-center rounded-3xl border-primary/20">
          <h2 className="text-3xl md:text-5xl font-extrabold mb-6 tracking-tight">
            Ready to explore Pure Desi Haryanvi?
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Join our community to discover the best regional music videos, shows, and exclusive cultural content.
          </p>
          ...
          <p className="mt-6 text-sm text-muted-foreground">
            Free to join • Exclusive Content
          </p>
        </div>
      </div>
    </section>
